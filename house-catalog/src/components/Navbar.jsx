...
import { Navbar, Container, Nav, Dropdown } from 'react-bootstrap'; // Import only necessary components from react-bootstrap
...
<Navbar expand="lg" bg="white" className="shadow container-padre">
  <Container className="custom-container">
    {/* Dropdown Menu */}
    <Dropdown>
      <Dropdown.Toggle variant="white" id="dropdown-basic" className="shadow-none border-0">
        Menu
      </Dropdown.Toggle>

      <Dropdown.Menu>
        <Dropdown.Item as={Link} to="/buy-a-house">Buy</Dropdown.Item>
        <Dropdown.Item as={Link} to="/rent-a-house">Rent</Dropdown.Item>
    ...
    <Navbar.Brand as={Link} to="/home" className="mx-auto imagen-personal">
      <img src="/pics/Screenshot 2024-11-27 at 10.18.18 p.m..png" alt="Logo" />
    </Navbar.Brand>
  </Container>
</Navbar>
